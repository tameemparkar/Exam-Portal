...
const metadata = { title: `Students - ${CONFIG.appName}` };
    ...
    <>
      ...
      <DashboardContent maxWidth="xl">
        ...
        <Typography variant="body2">
          {' '}
          Track, analyze, and manage every student’s journey at a glance.
        </Typography>
        {/* {renderContent()} */}
        <Divider sx={{ my: 4 }} />
              ...
              <Tab
                ...
                icon={
                  <Label
                    ...
                    color={
                      (tab.value === 'male' && 'info') ||
                      (tab.value === 'female' && 'primary') ||
                      'default'
                    }
                  >
                    {['male', 'female'].includes(tab.value)
