...
const ICONS = {
  ...
  archive: icon('ic-archive'),
  test_builder: icon('ic-test_builder'),
  dashboardicon: icon('ic-dashboardicon'),
  avatar: icon('ic-avatar'),
  exams: icon('ic-exams'),
...
export const navData: NavSectionProps['data'] = [
   ...
   */
  {
    subheader: 'General',
    items: [
      { title: 'Dashboard', path: paths.dashboard.root, icon: ICONS.dashboardicon },
      { title: 'Test Builder', path: paths.dashboard.testbuilder, icon: ICONS.test_builder },
      { title: 'Exams', path: paths.dashboard.exams, icon: ICONS.exams },
      { title: 'My Tests', path: paths.dashboard.mytests, icon: ICONS.archive },
      { title: 'Reports', path: paths.dashboard.reports, icon: ICONS.analytics },
      { title: 'Students', path: paths.dashboard.students, icon: ICONS.avatar },
